...
<%
    ...
    try {
        ...
        while(files.hasMoreElements()) {
            ...
            if(!file.endsWith(".pdf") && !file.endsWith(".doc") && !file.endsWith(".txt")) {
                File errorFile = new File(path + file);
                     errorFile.delete();
                System.out.println("It is error file format.");
            } else {
                if(originFile != null && originFile.trim().length() > 0 ) {
